...
import (
	...
	"github.com/kroma-labs/sentinel-go/example/sql/internal/database"
	"github.com/kroma-labs/sentinel-go/example/sql/internal/telemetry"
...
func main() {
	...
	// 3. Open Database Connection with Sentinel
	...
	fmt.Println("✅ Example app started!")
